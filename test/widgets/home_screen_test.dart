...
void main() {
  testWidgets('shows empty state when there are no habits',
  ...
  testWidgets('lists existing habits and hides the empty state',
      (WidgetTester tester) async {
  ...
  testWidgets('the add-habit FAB is present and labeled',
      (WidgetTester tester) async {
    await pumpAndSettleTest(
      tester,
      wrapForTest(const HomeScreen(), initialHabits: <Habit>[]),
